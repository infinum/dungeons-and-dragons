...
export default [{
  ...
  duration: '1 round',
  higherLevel: '<p>When you cast this spell using a spell slot of 2nd level or higher, the extra damage increases by 1d6 for each slot level above 1st.</p>',
  level: 1,
  ...
  duration: 'Instantaneous',
  higherLevel: '<p>When you cast this spell using a spell slot of 3nd level or higher, the damage increases by 1d8 for each slot level above 2st.</p>',
  level: 2,
  ...
  duration: '8 hours',
  higherLevel: '<p>When you cast this spell using a spell slot of 3rd level or higher, a target’s hit points increase by an additional 5 for each slot level above 2nd.</p>',
  level: 2,
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 2nd level or higher, you can affect one additional beast for each slot level above 1st.</p>',
  page: 'phb 212',
  range: '30 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>If you cast this spell using a spell slot of 3nd level or higher, the duration of the spell increases by 48 hours for each slot level above 2nd.</p>',
  page: 'phb 212',
  range: '30 feet',
  components: 'V, S, M',
  material: 'A morsel of food.',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 4th level or higher, you animate or reassert control over two additional undead creatures for each slot level above 3rd. Each of the creatures must come from a different corpse or pile of bones.</p>',
  page: 'phb 212',
  range: '10 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>If you cast this spell using a spell slot of 6th level or higher, you can animate two additional objects for each slot level above 5th.</p>',
  page: 'phb 213',
  range: '120 feet',
  components: 'V, S',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 2nd level or higher, both the temporary hit points and the cold damage increase by 5 for each slot level above 1st.</p>',
  page: 'phb 215',
  range: 'Self',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 2nd level or higher, the damage increases by 1d6 for each slot level above 1st.</p>',
  page: 'phb 215',
  range: 'Self',
  components: 'V, S',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 2nd level or higher, you can target one additional creature for each slot level above 1st.</p>',
  page: 'phb 216',
  range: '30 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 5th level or higher, you can target one additional creature for each slot level above 4th.</p>',
  page: 'phb 217',
  range: '60 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>If you cast this spell using a spell slot of 4th level or higher, the duration is concentration, up to 10 minutes. If you use a spell slot of 5th level or higher, the duration is 8 hours. If you use a spell slot of 7th level or higher, the duration is 24 hours. If you use a 9th level spell slot, the spell lasts until it is dispelled. Using a spell slot of 5th level or higher grants a duration that doesn’t require concentration.</p>',
  page: 'phb 218',
  range: 'Touch',
  components: 'V, S',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 6th level or higher, the damage from the clenched fist option increases by 2d8 and the damage from the grasping hand increases by 2d6 for each slot level above 5th.</p>',
  page: 'phb 218',
  range: '120 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 5th level of higher, the damage increases by 1d8 for each slot level above 4th.</p>',
  page: 'phb 219',
  range: '30 feet',
  components: 'V, S',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 3rd level or higher, you can target one additional creature for each slot level above 2nd.</p>',
  page: 'phb 219',
  range: '30 feet',
  components: 'V',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 7th level or higher, you can create two additional pillars for each slot level above 6th.</p>',
  page: 'ee pc 15',
  range: '120 feet',
  components: 'V, S',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 3rd level or higher, the extra damage increases by 1d6 for each slot level above 2nd.</p>',
  page: 'phb 219',
  range: 'Self',
  components: 'V',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 4th or higher level, the damage increases by 1d10 for each slot level above 3rd.</p>',
  page: 'phb 220',
  range: '120 feet',
  components: 'V, S',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 2nd level or higher, the maximum weight of objects that you can target with this spell increases by 5 pounds, and the damage increases by 1d8, for each slot level above 1st.</p>',
  page: 'ee pc 15',
  range: '150 feet',
  components: 'S',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 7th level or higher, one additional bolt leaps from the first target to another target for each slot level above 6th.</p>',
  page: 'phb 221',
  range: '150 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 2nd level or higher, you can target one additional creature for each slot level above 1st. The creatures must be within 30 feet of each other when you target them.</p>',
  page: 'phb 221',
  range: '30 feet',
  components: 'V, S',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 2nd level or higher, the damage increases by 1d8 for each slot level above 1st.</p>',
  page: 'phb 221',
  range: '90 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 7th level or higher, the damage increases by 2d6 for each slot level above 6th.</p>',
  page: 'phb 221',
  range: '150 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 3rd level or higher, the damage increases by 2d4 for each slot level above 2nd.</p>',
  page: 'phb 222',
  range: '60 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 6th level or higher, the damage increases by 1d8 for each slot level above 5th.</p>',
  page: 'phb 222',
  range: '120 feet',
  components: 'V, S',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 2nd level or higher, roll an additional 2d10 for each slot level above 1st.</p>',
  page: 'phb 222',
  range: 'Self',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 2nd level or higher, you can affect one additional creature for each slot level above 1st. The creatures must be within 30 feet of each other when you target them.</p>',
  page: 'phb 223',
  range: '60 feet',
  components: 'V',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a level spell slot 5 or more, the radius of the sphere increases by 5 feet for each level of higher spell slot to 4.</p>',
  page: 'phb 224',
  range: '90 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using certain higher-level spell slots, you choose one of the summoning options above, and more creatures appear: twice as many with a 5th-level slot, three times as many with a 7th-level.</p>',
  page: 'phb 225',
  range: '60 feet',
  components: 'V, S',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a 9th-level spell slot, you summon a celestial of challenge rating 5 or lower.</p>',
  page: 'phb 225',
  range: '90 feet',
  components: 'V, S',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 6th level or higher, the challenge rating increases by 1 for each slot level above 5th.</p>',
  page: 'phb 225',
  range: '90 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 7th level or higher, the challenge rating increases by 1 for each slot level above 6th.</p>',
  page: 'phb 226',
  range: '90 feet',
  components: 'V, S',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using certain higher-level spell slots, you choose one of the summoning options above, and more creatures appear: twice as many with a 6th-level slot and three times as many with an 8th-level slot.</p>',
  page: 'phb 226',
  range: '90 feet',
  components: 'V, S',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 3rd level or higher, the amount of ammunition that can be affected increases by two for each slot level above 2nd.</p>',
  page: 'phb 228',
  range: '5 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 4th level or higher, the interrupted spell has no effect if its level is less than or equal to the level of the spell slot you used.</p>',
  page: 'phb 228',
  range: '60 feet',
  components: 'S',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 2nd level or higher, you create or destroy 10 additional gallons of water, or the size of the cube increases by 5 feet, for each slot level above 1st.</p>',
  page: 'phb 229',
  range: '30 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a 7th-level spell slot, you can animate or reassert control over four ghouls. When you cast this spell using an 8th-level spell slot, you can animate or reassert control over five ghouls or two ghasts or wights. When you cast this spell using a 9th-level spell slot, you can animate or reassert control over six ghouls, three ghasts or wights, or two mummies.</p>',
  page: 'phb 229',
  range: '10 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 6th level or higher, the cube increases by 5 feet for each slot level above 5th.</p>',
  page: 'phb 229',
  range: '30 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 2nd level or higher, the healing increases by 1d8 for each slot level above 1st.</p>',
  page: 'phb 230',
  range: 'Touch',
  components: 'V, S',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 8th level or higher, the base damage increases by 1d6 for each slot level above 7th.</p>',
  page: 'phb 230',
  range: '150 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 7th level or higher, the damage increases by 3d6 for each slot level above 6th.</p>',
  page: 'phb 233',
  range: '60 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 4th level or higher, you automatically end the effects of a spell on the target if the spell’s level is equal to or less than the level of the spell slot you used.</p>',
  page: 'phb 234',
  range: '120 feet',
  components: 'V, S',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell with a 9th level spell slot, the duration is concentration, up to 8 hours.</p>',
  page: 'phb 234',
  range: '60 feet',
  components: 'V, S',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a 6th-level spell slot, the duration is concentration, up to 10 minutes. When you use a 7th-level spell slot, the duration is concentration, up to 1 hour. When you use a spell slot of 8th level or higher, the duration is concentration, up to 8 hours.</p>',
  page: 'phb 235',
  range: '60 feet',
  components: 'V, S',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 3rd level or higher, the damage increases by 1d8 for each slot level above 2nd.</p>',
  page: 'ee pc 17',
  range: '60 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 5th level or higher, you can target one additional creature for each slot level above 4th. The creatures must be within 30 feet of each other when you target them.</p>',
  page: 'ee pc 17',
  range: '90 feet',
  components: 'V, S',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 5th or 6th level, the bonus to attack rolls increases to +2 and the extra damage increases to 2d4. When you use a spell slot of 7th level or higher, the bonus increases to +3 and the extra damage increases to 3d4.</p>',
  page: 'phb 237',
  range: 'Touch',
  components: 'V, S',
  ritual: false,
  ...
  higherLevel: '<p>If you cast this spell using a spell slot of 2nd level or higher, the damage increases by 1d6 for each slot level above 1st.</p>',
  page: 'phb 237',
  range: 'Self',
  components: 'V',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 3rd level or higher, the damage increases by 1d12 for each slot level above 2nd.</p>',
  page: 'ee pc 17',
  range: '120 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 8th level or higher, you can target up to three willing creatures (including you) for each slot level above 7th. The creatures must be within 10 feet of you when you cast the spell.</p>',
  page: 'phb 238',
  range: 'Self',
  components: 'V, S',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 2nd level or higher, you gain 5 additional temporary hit points for each slot level above 1st.</p>',
  page: 'phb 239',
  range: 'Self',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 4th level or higher, the damage increases by 1d6 for each slot level above 3rd.</p>',
  page: 'phb 241',
  range: '150 feet',
  components: 'V, S, M',
  material: 'A tiny ball of bat guano and sulfur.',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 4th level or higher, the number of pieces of ammunition you can affect with this spell increases by two for each slot level above 3rd.</p>',
  page: 'ee pc 18',
  range: 'Touch',
  components: 'V, S',
  ritual: false,
  ...
  level: 3,
  school: 'Transmutation',
  class: ['druid', 'ranger', 'sorcerer', 'Wwzard'],
}, {
  name: 'Flame Blade',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 4th level or higher, the damage increases by 1d6 for every two slot levels above 2nd.</p>',
  page: 'phb 242',
  range: 'Self',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 6th level or higher, the fire damage or the radiant damage (your choice) increases by 1d6 for each slot level above 5th.</p>',
  page: 'phb 242',
  range: '60 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 3rd level or higher, the damage increases by 1d6 for each slot level above 2nd.</p>',
  page: 'phb 242',
  range: '60 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 4th level or higher, you can target one additional creature for each slot level above 3rd.</p>',
  page: 'phb 243',
  range: 'Touch',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 2nd level or higher, the radius of the fog increases by 20 feet for each slot level above 1st.</p>',
  page: 'phb 243',
  range: '120 feet',
  components: 'V, S',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 7th or 8th level, the duration is 1 year. When you cast this spell using a spell slot of 9th level, the spell lasts until it is ended by one of the spells mentioned above.</p>',
  page: 'phb 244',
  range: '60 feet',
  components: 'V',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 7th level or higher, the barrier blocks spells of one level higher for each slot level above 6th.</p>',
  page: 'phb 245',
  range: 'Self',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a 4 or higher is level, the damage explosive runes increased by 1d8 for each level of top slot 3. If you create a glyph spell, you may store a spell whose level is equivalent or less to spell slot used for the custody of the glyph.</p>',
  page: 'phb 245',
  range: 'Touch',
  components: 'V, S, M',
  ...
  higherLevel: '<p>If you cast this spell using a spell slot of 2nd level or higher, the damage increases by 1d10 for each slot level above 1st (to a maximum of 6d10).</p>',
  page: 'phb 249',
  range: 'Self',
  components: 'V',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 7th level or higher, the amount of healing increases by 10 for each slot level above 6th.</p>',
  page: 'phb 250',
  range: '60 feet',
  components: 'V, S',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 2nd level or higher, the healing increases by 1d4 for each slot level above 1st.</p>',
  page: 'phb 250',
  range: '60 feet',
  components: 'V',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 2nd level or higher, the damage increases by 1d10 for each slot level above 1st.</p>',
  page: 'phb 250',
  range: '60 feet',
  components: 'V, S',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 3rd or 4th level, you can maintain your concentration on the spell for up to 8 hours. When you use a spell slot of 5th level or higher, you can maintain your concentration on the spell for up to 24 hours.</p>',
  page: 'phb 251',
  range: '90 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a level 6 or higher location, you can target an additional creature for each level of location beyond the fifth. The creatures must be within 30 feet o f each other when you target them.</p>',
  page: 'phb 251',
  range: '90 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 3rd level or higher, you can target one additional humanoid for each slot level above 2nd. The humanoids must be within 30 feet of each other when you target them.</p>',
  page: 'phb 251',
  range: '60 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 2nd level or higher, the cold damage increases by 1d6 for each slot level above 1st.</p>',
  page: 'ee pc 19',
  range: '60 feet',
  components: 'S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 5th level or higher, the bludgeoning damage increases by 1d8 for each slot level above 4th.</p>',
  page: 'phb 252',
  range: '300 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 6th level or higher, the damage increases by 1d10 for each slot level above 5th.</p>',
  page: 'phb 254',
  range: '300 feet',
  components: 'V, S, M',
...

{
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 4th level or higher, the damage for both effects of the spell increases by 1d8 for each slot level above 3rd.</p>',
  page: 'phb 255',
  range: 'Self',
  components: 'V, S',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 2nd level or higher, you can target one additional creature for each spell slot above 1st.</p>',
  page: 'phb 256',
  range: 'Touch',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 4th level or higher, the duration increases by 1 hour for each slot level above 3rd.</p>',
  page: 'phb 256',
  range: '10 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 2nd level or higher, the spell creates one more dart for each slot level above 1st.</p>',
  page: 'phb 257',
  range: '120 feet',
  components: 'V, S',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 4th level or higher, the bonus increases to +2. When you use a spell slot of 6th level or higher, the bonus increases to +3.</p>',
  page: 'phb 257',
  range: 'Touch',
  components: 'V, S',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 6th level or higher, the spell lasts until dispelled, without requiring your concentration.</p>',
  page: 'phb 258',
  range: '120 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 6th level or higher, the healing increases by 1d8 for each slot level above 5th.</p>',
  page: 'phb 258',
  range: '60 feet',
  components: 'V, S',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 4th level or higher, the healing increases by 1d4 for each slot level above 3rd.</p>',
  page: 'phb 258',
  range: '60 feet',
  components: 'V',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a 7th-level spell slot, the duration is 10 days. When you use an 8th-level spell slot, the duration is 30 days. When you use a 9th-level spell slot, the duration is a year and a day.</p>',
  page: 'phb 258',
  range: '60 feet',
  components: 'V, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 3rd level or higher, the damage (both initial and later) increases by 1d4 for each slot level above 2nd.</p>',
  page: 'phb 259',
  range: '90 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 4th level or higher, the number of meteors created increases by two for each slot level above 3rd.</p>',
  page: 'ee pc 20',
  range: 'Self',
  components: 'V, S, M',
  ...
  higherLevel: '<p>If you cast this spell using a spell slot of 6th level or higher, you can alter the target’s memories of an event that took place up to 7 days ago (6th level), 30 days ago (7th level), 1 year ago (8th level), or any time in the creature’s past (9th level).</p>',
  page: 'phb 261',
  range: '30 feet',
  components: 'V, S',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 3rd level or higher, the damage increases by 1dlO for each slot level above 2nd.</p>',
  page: 'phb 261',
  range: '120 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 5th level or higher, you can increase the size of the cube by 100 feet for each slot level beyond 4th. Thus you could protect a cube that can be up to 200 feet on one side by using a spell slot of 5th level.</p>',
  page: 'phb 262',
  range: '120 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 7th level or higher, the damage increases by 1d6 for each slot level above 6th.</p>',
  page: 'phb 263',
  range: '300 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 5th level or higher, the damage increases by 1dlO for each slot level above 4th.</p>',
  page: 'phb 265',
  range: '120 feet',
  components: 'V, S',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of a higher level, the duration increases to 10 days with a 6th-level slot, to 30 days with a 7th-level slot, to 180 days with an 8th-level slot, and to a year and a day with a 9th-level spell slot.</p>',
  page: 'phb 265',
  range: '60 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 3rd level or higher, the healing increases by 1d8 for each slot level above 2nd.</p>',
  page: 'phb 267',
  range: '30 feet',
  components: 'V',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a 3 or higher level spell slot, you generate an additional radius for each level of higher spell slot 2.</p>',
  page: 'phb 273',
  range: '120 feet',
  components: 'V, S',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 2nd level or higher, the initial extra damage dealt by the attack increases by 1d6 for each slot level above 1st.</p>',
  page: 'phb 274',
  range: 'Self',
  components: 'V',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a 3 or higher level spell slot, the damage of the spell increases by 1d8 for each level of higher spell slot 2.</p>',
  page: 'phb 275',
  range: '60 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 2nd level or higher, roll an additional 2d8 for each slot level above 1st.</p>',
  page: 'phb 276',
  range: '90 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 4th level or higher, the damage increases by 1d8 for each slot level above 3rd.</p>',
  page: 'phb 278',
  range: 'Self',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 3rd level or higher, the damage increases by 1d8 for every two slot levels above the 2nd.</p>',
  page: 'phb 278',
  range: '60 feet',
  components: 'V, S',
  ritual: false,
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 5th level or higher, the damage increases for each of its effects by 1d6 for each slot level above 4th.</p>',
  page: 'ee pc 22',
  range: '150 feet',
  components: 'V, S',
  ritual: false,
...

{
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 5th level or higher, the initial damage increases by 2d4 for each slot level above 4th.</p>',
  page: 'ee pc 23',
  range: '150 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a level spell slot 5 or more, the damage of the spell increases by 1d8 for each level of higher spell slot to 4.</p>',
  page: 'phb 285',
  range: '120 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 7th level or higher, the damage the wall deals when it appears increases by 2d6, and the damage from passing through the sheet of frigid air increases by 1d6, for each slot level above 6th.</p>',
  page: 'phb 285',
  range: '120 feet',
  components: 'V, S, M',
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 7th level or higher, both types of damage increase by 1d8 for each slot level above 6th.</p>',
  page: 'phb 287',
  range: '120 feet',
  components: 'V, S, M',
...

{
  ...
  higherLevel: '<p>When you cast this spell using a spell slot of 2nd level or higher, the damage increases by 1d12 for each slot level above 1st.</p>',
  page: 'phb 289',
  range: '30 feet',
  components: 'V, S, M',
